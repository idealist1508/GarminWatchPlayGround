...
namespace vestervang.DotNetBlueZ
{
  public static class Extensions
  {
    ...
    {
      var devices =  BlueZManager.GetProxies<IDevice1>(BluezConstants.DeviceInterface, adapter);
    ...
    {
      var services = BlueZManager.GetProxies<IGattService1>(BluezConstants.GattServiceInterface, device);
    ...
    public static IReadOnlyList<IGattService1> GetServices(this IDevice1 device)
    {
        return BlueZManager.GetProxies<IGattService1>(BluezConstants.GattServiceInterface, device);
    }

    public static async Task<GattCharacteristic> GetCharacteristicAsync(this IGattService1 service, string characteristicUUID)
    {
      var characteristics = BlueZManager.GetProxies<IGattCharacteristic1>(BluezConstants.GattCharacteristicInterface, service);
    ...
    public static IReadOnlyList<IGattCharacteristic1> GetCharacteristics(this IGattService1 service)
    {
        return BlueZManager.GetProxies<IGattCharacteristic1>(BluezConstants.GattCharacteristicInterface, service);
    }
